...
export default function HomePage() {
  return (
    <div className="max-w-6xl mx-auto px-6 lg:px-8 py-14 space-y-20">
      {/* ── Hero ──────────────────────────────────────────────────────────── */}
      <header className="text-center space-y-6 pt-6 animate-fade-up">
        <p className="eyebrow">No. 01 — Autonomous Machine Learning</p>
        <h1 className="font-display text-6xl sm:text-7xl text-bone tracking-tight leading-[0.98] font-medium">
          A model, made to
          <br />
          <span className="text-gold-shimmer italic">measure.</span>
        </h1>
        <p className="text-bone-dim text-base max-w-xl mx-auto leading-[1.8] font-normal">
          Present a dataset and state your intention. Ten agents will audit, explore,
          engineer, train, and tune — then return a deployed model with its
          full reasoning on record.
        </p>
        {/* thin gold divider */}
      ...
      {/* ── Commission card (upload) ──────────────────────────────────────── */}
      <section
        className="max-w-2xl mx-auto animate-fade-up"
        style={{ animationDelay: '150ms' }}
      >
        <div className="lux-card-gold corner-ticks p-8">
          <div className="flex items-baseline justify-between mb-8">
            <h2 className="font-display text-2xl text-bone gold-rule">Commission a Model</h2>
      ...
      <section className="space-y-8">
        <p className="eyebrow-dim text-center">The Process — Ten Hands, One Work</p>
      ...
      <footer className="text-center space-y-5 pb-8">
        <p className="eyebrow-dim">Instruments</p>
